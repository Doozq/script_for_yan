...
from config import t_size, download_path

import logger_setup

def color_from_template(template_path, pixel_coords):
    try:
        path = download_path + template_path
        start_x, start_y = tournament_templates[template_path]["start"]
